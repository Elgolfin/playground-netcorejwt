...
using playground_netcorejwt.ViewModels;
using System;
...
namespace SampleMvcApp.Controllers
{
    public class AccountController : Controller
    {
            ...
            if (ModelState.IsValid)
            {
                try
                {
                    ...
                    var result = await client.GetTokenAsync(new ResourceOwnerTokenRequest
                    {
                        ...
                        Audience = _configuration["Authentication:auth0:audience"],
                    });
                    ...
                    var claimsPrincipal = new ClaimsPrincipal(new ClaimsIdentity(new[]
                    {
                        ...
                        new Claim($"{_configuration["Authentication:auth0:audience"]}access_token", result.AccessToken),
                        new Claim($"{_configuration["Authentication:auth0:audience"]}id_token", result.IdToken),
        ...
        [Authorize]
        public async Task<ActionResult<object>> IdToken()
        {
        ...
        [Authorize]
        public async Task<ActionResult<object>> AccessToken()
        {
